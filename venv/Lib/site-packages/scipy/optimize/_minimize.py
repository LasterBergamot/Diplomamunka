"""
Unified interfaces to minimization algorithm.
...
def minimize(fun, x0, args=(), method=None, jac=None, hess=None,
    ...
    See also
    --------
    minimize_scalar : Interface to minimization algorithm for scalar
    ...
    **Unconstrained minimization**
    ...
    trusted, other algorithm using the first and/or second derivatives
    ...
    **Custom minimizers**
    ...
    .. [10] Powell M J D. Direct search algorithm for optimization
       calculations. 1998. Acta Numerica 7: 287-336.
    .. [11] Powell M J D. A view of algorithm for optimization without
...
def minimize_scalar(fun, bracket=None, bounds=None, args=(),
    ...
    See also
    --------
    minimize : Interface to minimization algorithm for scalar multivariate
        functions
    show_options : Additional options accepted by the solvers

...
def basinhopping(func, x0, niter=100, T=1.0, stepsize=0.5,
    ...
    take_step : callable ``take_step(x)``, optional
        ...
        other step-taking algorithm may be better for some systems.
    ...
    Carlo algorithm, although there are many other possibilities [3]_.
    ...
    advanced step taking algorithm and alternate acceptance criterion.

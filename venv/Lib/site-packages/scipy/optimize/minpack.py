...
def fsolve(func, x0, args=(), fprime=None, full_output=0,
    ...
    See Also
    --------
    root : Interface to root finding algorithm for multivariate
           functions. See the ``method=='hybr'`` in particular.

    Notes
    -----
    ``fsolve`` is a wrapper around MINPACK's hybrd and hybrj algorithm.
...
def leastsq(func, x0, args=(), Dfun=None, full_output=0,
    ...
    Notes
    -----
    "leastsq" is a wrapper around MINPACK's lmdif and lmder algorithm.

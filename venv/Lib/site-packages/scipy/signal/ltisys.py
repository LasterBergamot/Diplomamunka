...
def place_poles(A, B, poles, method="YT", rtol=1e-3, maxiter=30):
    ...
    method: {'YT', 'KNV0'}, optional
        ...
        See References and Notes for details on the algorithm.
    rtol: float, optional
    ...
    full_state_feedback : Bunch object
        full_state_feedback is composed of:
            ...
            rtol : float
                ...
                algorithm can't do anything i.e when ``B.shape[1] == 1``.
            nb_iter : int
    ...
    implementation of these algorithm.
    ...
    .. [1] J. Kautsky, N.K. Nichols and P. van Dooren, "Robust pole assignment
           ...
           pp. 1129-1155, 1985.
    .. [2] A.L. Tits and Y. Yang, "Globally convergent algorithm for robust
    ...
    algorithm.  This is example number 1 from section 4 of the reference KNV
    publication ([1]_):

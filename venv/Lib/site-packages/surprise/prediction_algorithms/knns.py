"""
the :mod:`knns` module includes some k-NN inspired algorithm.
"""
...
class SymmetricAlgo(AlgoBase):
    """This is an abstract class aimed to ease the use of symmetric algorithm.

    A symmetric algorithm is an algorithm that can can be based on users or on
    items indifferently, e.g. all the algorithm in this module.

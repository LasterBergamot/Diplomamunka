...
class AlgoBase(object):
    ...
    def compute_baselines(self):
        ...
        This method is only relevant for algorithm using :func:`Pearson
    ...
    def compute_similarities(self):
        ...
        This method is only relevant for algorithm using a similarity measure,
        such as the :ref:`k-NN algorithm <pred_package_knn_inpired>`.
